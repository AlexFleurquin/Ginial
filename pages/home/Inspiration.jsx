        ...
        <div className="py-12 md:pt-32 md:pb-20">
          ...
          <div className="pb-12 md:pb-14">
            <div className="relative text-center md:text-left">
              ...
              <h2 className="h2">Latest inspiration</h2>
            </div>
          </div>
          {/* Content */}
          <div>
              ...
              >
                ...
                >
                  <Image
                    ...
                    src="/static/images/home/inspiration-01.jpg"
                    width="352"
                    height="352"
                    alt="Inspiration 01"
                  />
                    ...
                    <div className="relative flex justify-between">
                      ...
                      <div className="flex items-center">
                        <Image
                          ...
                          src="/static/images/home/author-01.jpg"
                          width="36"
                          height="36"
                          alt="Author 01"
                        />
                ...
                >
                  <Image
                    className="w-full aspect-square object-cover"
                    src="/static/images/home/inspiration-02.jpg"
                    width="352"
                    height="352"
                    alt="Inspiration 02"
                  />
                ...
                >
                  <Image
                    className="w-full aspect-square object-cover"
                    src="/static/images/home/inspiration-03.jpg"
                    width="352"
                    height="352"
                    alt="Inspiration 03"
                  />
                ...
                >
                  <Image
                    className="w-full aspect-square object-cover"
                    src="/static/images/home/inspiration-04.jpg"
                    width="352"
                    height="352"
                    alt="Inspiration 04"
                  />
                ...
                >
                  <Image
                    className="w-full aspect-square object-cover"
                    src="/static/images/home/inspiration-05.jpg"
                    width="352"
                    height="352"
                    alt="Inspiration 05"
                  />
                ...
                >
                  <Image
                    className="w-full aspect-square object-cover"
                    src="/static/images/home/inspiration-06.jpg"
                    width="352"
                    height="352"
                    alt="Inspiration 06"
                  />
                ...
                >
                  <Image
                    className="w-full aspect-square object-cover"
                    src="/static/images/home/inspiration-07.jpg"
                    width="352"
                    height="352"
                    alt="Inspiration 07"
                  />
                ...
                >
                  <Image
                    className="w-full aspect-square object-cover"
                    src="/static/images/home/inspiration-08.jpg"
                    width="352"
                    height="352"
                    alt="Inspiration 08"
                  />
                ...
                >
                  <Image
                    className="w-full aspect-square object-cover"
                    src="/static/images/home/inspiration-09.jpg"
                    width="352"
                    height="352"
                    alt="Inspiration 09"
                  />
