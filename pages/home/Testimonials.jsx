                ...
                <div className="swiper-wrapper">
                  ...
                  <div className="swiper-slide space-y-8 lg:flex items-center lg:space-y-0 lg:space-x-8 text-center lg:text-left">
                    <div className="shrink-0 relative inline-flex">
                      <Image
                        ...
                        src="/static/images/home/testimonial-01.jpg"
                        width="280"
                        height="280"
                        alt="Testimonial 01"
                      />
                    ...
                    <div className="relative">
                      ...
                      <h4 className="h3  mb-4">
                        I've been using Community Club to track my ideas, and
                  ...
                  <div className="swiper-slide space-y-8 lg:flex items-center lg:space-y-0 lg:space-x-8 text-center lg:text-left">
                    <div className="shrink-0 relative inline-flex">
                      <Image
                        className="rounded-full"
                        src="/static/images/home/testimonial-02.jpg"
                        width="280"
                        height="280"
                        alt="Testimonial 02"
                      />
                    ...
                    <div className="relative">
                      ...
                      <h4 className="h3  mb-4">
                        ...
                        implementation - Community Club's got you covered.
                      </h4>
                      <div>
                        <a
                          className="btn-sm text-white bg-blue-500 hover:bg-blue-600 group shadow-sm"
                  ...
                  <div className="swiper-slide space-y-8 lg:flex items-center lg:space-y-0 lg:space-x-8 text-center lg:text-left">
                    <div className="shrink-0 relative inline-flex">
                      <Image
                        className="rounded-full"
                        src="/static/images/home/testimonial-03.jpg"
                        width="280"
                        height="280"
                        alt="Testimonial 03"
                      />
                    ...
                    <div className="relative">
                      ...
                      <h4 className="h3  mb-4">
                        Community Club has really helped our business in many
