      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="pb-12 md:pb-20">
            <h2 className="h2  text-center md:text-left">From our blog</h2>
          </div>
          {/* Posts */}
          <div className="max-w-sm mx-auto md:max-w-none grid gap-12 md:grid-cols-3 md:gap-x-6 md:gap-y-8 items-start">
            ...
            >
              ...
              <a className="block group overflow-hidden" href="#0">
                <Image
                  ...
                  src="/static/images/home/blog-01.jpg"
                  width="347"
                  height="198"
                  alt="Post 01"
                />
              ...
              <div className="grow flex flex-col">
                <header>
                  <h3 className="h4  font-bold mb-2">
                    <a
                ...
                <footer className="flex items-center text-sm mt-4">
                  <a href="#0">
                    <Image
                      ...
                      src="/static/images/home/blog-author-01.jpg"
                      width="32"
                      height="32"
                      alt="Author 01"
                    />
            ...
            >
              ...
              <a className="block group overflow-hidden" href="#0">
                <Image
                  className="w-full aspect-[7/4] object-cover group-hover:scale-105 transition duration-700 ease-out"
                  src="/static/images/home/blog-02.jpg"
                  width="347"
                  height="198"
                  alt="Post 02"
                />
              ...
              <div className="grow flex flex-col">
                ...
                <footer className="flex items-center text-sm mt-4">
                  <a href="#0">
                    <Image
                      className="rounded-full shrink-0 mr-3"
                      src="/static/images/home/blog-author-02.jpg"
                      width="32"
                      height="32"
                      alt="Author 02"
                    />
            ...
            >
              ...
              <a className="block group overflow-hidden" href="#0">
                <Image
                  className="w-full aspect-[7/4] object-cover group-hover:scale-105 transition duration-700 ease-out"
                  src="/static/images/home/blog-03.jpg"
                  width="347"
                  height="198"
                  alt="Post 03"
                />
              ...
              <div className="grow flex flex-col">
                ...
                <footer className="flex items-center text-sm mt-4">
                  <a href="#0">
                    <img
                      className="rounded-full shrink-0 mr-3"
                      src="/static/images/home/blog-author-03.jpg"
                      width="32"
                      height="32"
                      alt="Author 03"
                    />
