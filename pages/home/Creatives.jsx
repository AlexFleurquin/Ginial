              ...
              <div className="flex space-x-6">
                ...
                <div className="w-1/2 space-y-6">
                  ...
                  >
                    <Image
                      ...
                      src="/static/images/home/creative-bg-01.jpg"
                      width="258"
                      height="64"
                      alt="Creative 01 bg"
                    />
                    <div className="bg-white px-4 pb-6">
                      <div className="relative inline-flex -mt-8 mb-3">
                        <Image
                          ...
                          src="/static/images/home/creative-01.jpg"
                          width="64"
                          height="64"
                          alt="Creative 01"
                        />
                  ...
                  >
                    <Image
                      className="w-full h-16 object-cover opacity-60"
                      src="/static/images/home/creative-bg-02.jpg"
                      width="258"
                      height="64"
                      alt="Creative 02 bg"
                    />
                    <div className="bg-white px-4 pb-6">
                      <div className="relative inline-flex -mt-8 mb-3">
                        <Image
                          className="inline-flex rounded-full"
                          src="/static/images/home/creative-02.jpg"
                          width="64"
                          height="64"
                          alt="Creative 01"
                        />
                ...
                <div className="w-1/2 mt-6 space-y-6">
                  ...
                  >
                    <Image
                      className="w-full h-16 object-cover opacity-60"
                      src="/static/images/home/creative-bg-03.jpg"
                      width="258"
                      height="64"
                      alt="Creative 03 bg"
                    />
                    <div className="bg-white px-4 pb-6">
                      <div className="relative inline-flex -mt-8 mb-3">
                        <Image
                          className="inline-flex rounded-full"
                          src="/static/images/home/creative-03.jpg"
                          width="64"
                          height="64"
                          alt="Creative 01"
                        />
                  ...
                  >
                    <Image
                      className="w-full h-16 object-cover opacity-60"
                      src="/static/images/home/creative-bg-04.jpg"
                      width="258"
                      height="64"
                      alt="Creative 04 bg"
                    />
                    <div className="bg-white px-4 pb-6">
                      <div className="relative inline-flex -mt-8 mb-3">
                        <Image
                          className="inline-flex rounded-full"
                          src="/static/images/home/creative-04.jpg"
                          width="64"
                          height="64"
                          alt="Creative 01"
                        />
            ...
            <div className="md:w-1/2 md:pl-10 lg:pl-20">
              <div className="text-center md:text-left">
                <Image
                  ...
                  alt="Creatives"
                />
                <h3 className="h3  text-4xl mb-4">More than a community</h3>
