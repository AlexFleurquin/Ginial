      ...
      >
        ...
        <defs>
          <linearGradient x1="0%" y1="100%" x2="50%" y2="0%" id="logo-a">
            <stop stopColor="#F9425F" stopOpacity=".8" offset="0%"></stop>
            <stop stopColor="#47A1F9" stopOpacity=".16" offset="100%"></stop>
          </linearGradient>
          <linearGradient x1="50%" y1="100%" x2="50%" y2="0%" id="logo-b">
            <stop stopColor="#FDFFDA" offset="0%"></stop>
            <stop
              stopColor="#F97059"
              stopOpacity=".798"
              offset="49.935%"
            ></stop>
            <stop stopColor="#F9425F" stopOpacity="0" offset="100%"></stop>
          </linearGradient>
        </defs>
